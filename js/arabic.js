        ...
        "columns": [
...

            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    var defaultLink = '<strong><a href="' + row['url'] + '" target="_blank">' + data + '</a><br/></strong>' + row['title'];
            ...
            //     "data": "tags",
            //     "render": function (data, type, row, meta) {
            //         tags = data.replace(/;_|_|;/g, "<br/>");
            //         Atags = checknull(row['classification']);
            //         Atags = Atags.replace(/::|_|;/g, "<br/>");
